...
public class MoverZombies : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        {
            distanciaPunto = Vector3.Distance(zombies[i].transform.position, puntos[zombies[i].GetComponent<DireccionZombie>().puntoDireccion].position);
            distanciaJugador = Vector3.Distance(zombies[i].transform.position, jugador.transform.position);

            if (distanciaJugador < 30)
            {

                direccionNormalizadaJugador = ((jugador.transform.position - zombies[i].transform.position).normalized);
                ...
                zombies[i].transform.rotation = Quaternion.Slerp(zombies[i].transform.rotation, direccionPunto, deltaTime * 5);


                zombies[i].transform.position = zombies[i].transform.position + zombies[i].transform.rotation * Vector3.forward * 10 * deltaTime;
            ...
            else
            {
                ...
                else
                {
                    ...
                    direccionNormalizadaPunto = ((puntos[zombies[i].GetComponent<DireccionZombie>().puntoDireccion].position - zombies[i].transform.position).normalized);
                    ...
                    zombies[i].transform.position = zombies[i].transform.position + zombies[i].transform.rotation * Vector3.forward * 30 * deltaTime;
